...
from saejongData.yesCrawler6_1.src.yesCrawler.items import YesCrawlerItem
...
#         contents = myselector.xpath('//table[52]//tr[2]//td[1]//table')
        ...
        for content in contents:
            ...
            if  item['Year_Month'] == '2006.03' or item['Year_Month'] == '2006.06' or item['Year_Month'] == '2006.09' or item['Year_Month'] == '2006.12' :      

                item['profit_06Y'] = content.xpath("tr[4]/td[2]/text()").extract() #순이익
                item['profit_07Y'] = content.xpath("tr[4]/td[3]/text()").extract() #순이익
                item['profit_08Y'] = content.xpath("tr[4]/td[4]/text()").extract() #순이익
                item['profit_09Y'] = content.xpath("tr[4]/td[5]/text()").extract() #순이익
                item['profit_10Y'] = content.xpath("tr[4]/td[6]/text()").extract() #순이익
                item['profit_11Y'] = content.xpath("tr[4]/td[7]/text()").extract() #순이익
                item['profit_12Y'] = content.xpath("tr[4]/td[8]/text()").extract() #순이익
                item['profit_13Y'] = content.xpath("tr[4]/td[9]/text()").extract() #순이익
                item['profit_14Y'] = content.xpath("tr[4]/td[10]/text()").extract() #순이익
                item['profit_15Y'] = content.xpath("tr[4]/td[11]/text()").extract() #순이익
                 
                item['asset_06Y'] = content.xpath("tr[6]/td[2]/text()").extract() #자산
                item['asset_07Y'] = content.xpath("tr[6]/td[3]/text()").extract() #자산
                item['asset_08Y'] = content.xpath("tr[6]/td[4]/text()").extract() #자산
                item['asset_09Y'] = content.xpath("tr[6]/td[5]/text()").extract() #자산
                item['asset_10Y'] = content.xpath("tr[6]/td[6]/text()").extract() #자산
                item['asset_11Y'] = content.xpath("tr[6]/td[7]/text()").extract() #자산
                item['asset_12Y'] = content.xpath("tr[6]/td[8]/text()").extract() #자산
                item['asset_13Y'] = content.xpath("tr[6]/td[9]/text()").extract() #자산
                item['asset_14Y'] = content.xpath("tr[6]/td[10]/text()").extract() #자산
                item['asset_15Y'] = content.xpath("tr[6]/td[11]/text()").extract() #자산
                 
                if (
                    len(item['profit_06Y'])==0 or 
